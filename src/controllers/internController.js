...
let createIntern = async function (req, res) {
    ...
    try {
        ...
        if (!validator.valid(mobile) || !validator.mobileRegex(mobile)) return res.status(400).send({ status: false, message: "please provide the mobile number inn valid format..." }) 
